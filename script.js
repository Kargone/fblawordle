...
'amount', 'amours', 'ampere', 'ampler', 'ampule', 'amtrak', 'amulet', 'amused', 'amuses', 'anally', 'analog', 'anchor', 'anemia', 'anemic', 'angels', 'angers', 'angina', 'angled', 
...
'cities', 'citing', 'citrus', 'claims', 'classy', 'clause', 'clever', 'clicks', 'client', 'cliffs', 'clinic', 'closed', 'closer', 'closes', 'closet', 'clouds', 'clutch', 'coated', 
...
'reject', 'relate', 'relied', 'relief', 'relies', 'remain', 'remedy', 'remind', 'remote', 'remove', 'render', 'rental', 'rented', 'repair', 'repeat', 'report', 'rescue', 'reside', 
